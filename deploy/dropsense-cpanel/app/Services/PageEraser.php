...
class PageEraser
{
     ...
     * inside the database, where Eloquent's deleting events never fire — an
     * observer on Audit would simply never run. True of the SQLite this was
     * written against and equally true of InnoDB.
     */
